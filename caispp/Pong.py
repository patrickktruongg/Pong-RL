...
# Next we need to transform those using ReLU
...
def main():
    ...
    decay_rate = 0.99 # for RMSProp algorithm
    num_hidden_layer_neurons = 200
    input_dimensions = 80 * 80
    learning_rate = 1e-4 # rate at which we learn from results --> higher rate, more reaction to results, lower rate, less reaction to results
    ...
    while True:
        ...
        if done: # an episode finished
            ...
            print("Episode: %d, episode reward total was %f, running mean: %f" % (episode_number, reward_sum, running_reward))
            reward_sum = 0
            prev_processed_observations = None
